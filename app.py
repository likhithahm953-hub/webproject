...
app.config.setdefault('SMTP_HOST', os.environ.get('SMTP_HOST', 'smtp.gmail.com'))
app.config.setdefault('SMTP_PORT', os.environ.get('SMTP_PORT', '587'))
app.config.setdefault('SMTP_USER', os.environ.get('SMTP_USER', 'manjunathmanjunatht71@gmail.com'))
app.config.setdefault('SMTP_PASS', os.environ.get('SMTP_PASS', ''))
app.config.setdefault('NODEMAILER_HOST', os.environ.get('NODEMAILER_HOST', 'smtp.gmail.com'))
app.config.setdefault('NODEMAILER_PORT', os.environ.get('NODEMAILER_PORT', '587'))
app.config.setdefault('NODEMAILER_USER', os.environ.get('NODEMAILER_USER', 'manjunathmanjunatht71@gmail.com'))
app.config.setdefault('NODEMAILER_PASS', os.environ.get('NODEMAILER_PASS', ''))
app.config.setdefault('EMAIL_FROM', os.environ.get('EMAIL_FROM', 'manjunathmanjunatht71@gmail.com'))
